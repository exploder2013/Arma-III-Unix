...
Main:
0x1956BB0 ; GameBase(0x1D56BB0-0x400000)
0x1740; RealPlayer
0x884; ObjTable (soldiers, cars)
0x68; Struct (for coordinates)
0x330; IsDead
0x798; playerID
0x700; Simple name for bots if playerID==1
--
0x814; Grass (set 50 to off)
! For Exile mod Namalsk grass is : 0x1D5C
(! on some servers check 0x804 or 0x808 offset)

Real players list:
0x1942598 + 0x24; Scoreboard
0x1C; Scoreboard size (num of players)
0x18; Scoreboard table array
0x120; PlayerPointer (i * 0x120)
0x4; NameID
0xA0; Real player name (if playerID == NameID)

For vehicle:
0xC10; Max passengers
0xC0C; PassengerPointer
0xBA0; DriverPointer
0xC80; Max gunners
0xC7C; Gunner Table
0x380; GunnerPointer
